    ...
    <section className="about section" id="about">
      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          projects.I am a front-end development enthusiast with a passion for
          creating visually appealing and user-friendly websites and
          applications. With extensive experience in MERN stack, I am committed
          to staying up-to-date with the latest industry trends and
          technologies. I thrive in collaborative environments and am always
          eager to learn from my colleagues and share my own knowledge and
          insights. My goal is to leverage my skills and expertise to build
          innovative and engaging digital experiences that exceed user
          expectations. I'm also quite interested to learn photo and video
          editing.
          </p>
